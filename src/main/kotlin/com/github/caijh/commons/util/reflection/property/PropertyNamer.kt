...
import com.github.caijh.commons.util.ReflectRuntimeException
...
object PropertyNamer {
    ...
    fun methodToProperty(name: String): String {
        ...
        propertyName = if (propertyName.startsWith("is")) {
            ...
            throw ReflectRuntimeException("Error parsing property name '$propertyName'.  Didn't start with 'is', 'get' or 'set'.")
        }
